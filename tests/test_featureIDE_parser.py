...
class TestFeatureIDEParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.input_folder = 'input_fms/FeatureIDE_models/'
        self.models = {
            
            
            #'wget':                [17, 0, 'wget', 2, 0, 1],           # fm_name -> nof_features, nof_constraints, root_name, core_features, or-groups, alternative-groups
                       #'tankwar':             [37, 0, 'TankWar', 7, 2, 6],
                       #'mobile_media2':       [43, 3, 'MobileMedia2', 10, 4, 3],
                       'WeaFQAs':             [179, 9, 'FQAs', 1, 12, 23],
                       ...
                       'jHipster':             [45, 13, 'JHipster', 0, 0, 10],
